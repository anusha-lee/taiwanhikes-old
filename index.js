            ...
            // Create and append the li's to the ul or divs to the parent div
             newHTML2.innerHTML += `
                <div class="events__oneDayFree--trip freeTrip">
                    <h3>活動Event:${val.Event}</h3>
                    <div class="freeTrip__date"><strong>日期Date:</strong> ${val.Date}</div>
                    <div class="freeTrip__meetup-time"><strong>集合時間Meetup Time:</strong> ${val.Meetup_Time}</div>
                    <div class="freeTrip__meetup-point"><strong>集合地點Meetup Point:</strong> ${val.Meetup_Point}</div>
                    <div class="freeTrip__transport"><strong>交通Transportation:</strong> ${val.Transportation}</div>
                    <div class="freeTrip__distance"><strong>里程Distance:</strong> ${val.Distance}</div>
                    <div class="freeTrip__difficulty-level"><strong>難度Difficulty Level:</strong> ${val.Difficulty_Level}</div>
                    <div class="freeTrip__club"><a href="#"><strong>社團Hiking Club:</strong> <a href="#">${val.Hiking_Club}</a></div>
                    <div class="freeTrip__guide"><strong>領隊Guide:</strong> ${val.Guide}</div>
                    <div class="freeTrip__about-Trail"><strong>路線簡介About the trail: <br></strong> ${val.About_the_trail}</div>
            `;
           }
        }
